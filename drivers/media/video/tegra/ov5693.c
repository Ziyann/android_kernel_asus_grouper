...
static const struct ov5693_reg ov5693_2560x1440_HDR_24fps_i2c[] = {
	{OV5693_TABLE_RESET, 0},/* Including sw reset */
	{0x0103, 0x01},
	{0x3001, 0x0a},
	{0x3002, 0x80},
...
static const struct ov5693_reg *mode_table[] = {
	...
	[OV5693_MODE_2560x1440_HDR]	= ov5693_2560x1440_HDR_24fps_i2c,
		...
		struct ov5693_mode *mode)
{
	...
	if (mode->hdr_en == true) {
		...
		else if (mode->res_x == 2560 && mode->res_y == 1440)
			mode_index = OV5693_MODE_2560x1440_HDR;
